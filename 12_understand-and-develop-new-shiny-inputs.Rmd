...
To make possible to **update** values from inputs we need to define the **setValue** method.
...
To make possible to **update inputs** from server we need to define the **receiveMessage** method.
