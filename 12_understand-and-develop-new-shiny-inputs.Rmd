...
To make possible to **updated** input value we need to define the **setValue** method.
...
> We can use it in combination of the **receiveMessage** to creare R funcions like **updateInput** where we call the `setValue` method inside
