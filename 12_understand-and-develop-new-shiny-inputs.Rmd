...
1. Let's the app without any new `javascript`.
...
3. Confirm it's impact in the app.
...
2. Add the JS dependencies the function `boxDeps()`.
...
Let's the effect of **slow rendering**.
